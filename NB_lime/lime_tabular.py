...
class LimeTabularExplainer_NB(object):
...
class RecurrentTabularExplainer(LimeTabularExplainer_NB):
    """
    ...
    just extends the LimeTabularExplainerSOM class and reshapes the training
